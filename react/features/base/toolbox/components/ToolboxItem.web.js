...
export default class ToolboxItem extends AbstractToolboxItem<Props> {
    ...
    _renderItem() {
        ...
        var className = showLabel ? 'overflow-menu-item' : 'toolbox-button';
        
        if(this.accessibilityLabel == 'Toggle screenshare') {
        ...
        var elementType = showLabel ? 'li' : 'div';
        ...
        let children = (
            <Fragment>
                { this._renderIcon()}
                {this.tooltip === 'Toggle tile view' && <span style={{display:'inline-block',lineHeight:'14px'}}>
                    {this.label}
                </span>}
                { showLabel && <span>
                    {this.label}
    ...
    _renderIcon() {
        ...
        const elementType = showLabel && this.accessibilityLabel != 'Toggle screenshare' ? 'span' : 'div';
